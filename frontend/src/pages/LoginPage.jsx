    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 to-gray-900">
      <div className="max-w-md w-full space-y-8 p-10 bg-gray-800 rounded-xl shadow-2xl">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Happy Jumper</h1>
          <p className="text-gray-300">Dashboard & Admin Panel</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          <p>Secure authentication via Discord OAuth2</p>
        </div>
      </div>
    </div>
  )
