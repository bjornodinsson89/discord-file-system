...
class EngagementRepository(RepositoryBase):
    ...
    async def upsert_guild_settings(self, guild_id: int, **changes: Any) -> dict:
        ...
        allowed = {
            ...
            "level_up_hjd_reward",
            "paid_raffle_purchase_coin_reward",
            "paid_raffle_purchase_hjd_reward",
            "jump_purchase_coin_reward",
            "jump_purchase_hjd_reward",
            "jump_completion_coin_reward",
            "jump_completion_hjd_reward",
